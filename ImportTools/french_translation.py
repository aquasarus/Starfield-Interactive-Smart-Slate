...
known_special_names = {
    ...
    'Lesser Silverfish': 'Petit lépisme',
    ...
    'Kreet Grazer': 'Herbivore de Kreet',
    'Kreet Stalker': 'Traqueur de Kreet',
}
...
known_species_names = {
    ...
    # MaamuT's surveys
    'Brainsprout': 'Encéphalobulbe',
    'Horsamander': 'Chevalamandre',
    'Bonefrill': 'Huître-os',
    'Clawback': 'Echinoserre',
    'Glowhands': 'Luisemain',
    'Cagebrain': 'Carcéphale',
    'Clickbeetle': 'Caraboclic',
    'Leafstrider': 'Phyliogerris',
    'Shardhopper': 'Saute-fragment',
    'Tongueface': 'Languos',
    'Stonewalker': 'Lithomarcheur',
    'Cutterhead': 'Coupereux',
    'Grub': 'Pupe',
    'Rockhound': 'Petraqueur',
    'Toadface': 'Batraface',
    'Grabber': 'Pince',
    'Boneback': 'Echinos',
    'Paddlefish': 'Poisson-pale',
    'Finback': 'Ailette',
    'Spaceroach': 'Spafard',
    'Canard': 'Canard',
    'Brightcage': 'Luise-cage',
    'Hornface': 'Cornicéphale',
    'Saturnine': 'Saturnin',
    'Seabat': 'Noctule-marine',
    'Stingray': 'Raie manta',
    'Windbag': 'Sac d\'air',
    'Mothwing': 'Aile de Sphinx',
    'Noid': 'Noïde',
    'Sailgator': 'Naviligator',
    'Vectorback': 'Glisse-dos',
    'Seahag': 'Vieille marine',
    'Brainblimp': 'Macrocortex',
    'Marnokk': 'Marnokk',
    'Scarab': 'Scarabée',
    'Shellephant': 'Coquéléphant',
    'Snuffler': 'Renifleur',
    'Tubecrawler': 'Veratube',
    'Mayfly': 'Ephémère',
    'Landshark': 'Terrosquale',
    'Silverfish': 'Lépisme',
    'Skullface': 'Crânegueule',
    'Twistfin': 'Révoloire',
    'Maggotmaw': 'Beclarve',
    'Bladehead': 'Lamette',
    'Sawhead': 'Tête de scie',
    'Flapwheel': 'Claque-roue',
    'Cranehopper': 'Criquet-grue',
    'Earback': 'Oreillon',
    'Lionbear': 'Leonursa',
    'Sporeback': 'Sporéchine',
    'Triantler': 'Tribois',
    'Glowback': 'Luciole',
    'Gossamer': 'Fil de vierge',
    'Boneglider': 'Ostéoplaneur',
    'Dragonfly': 'Libellule',
    'Lacraia': 'Lacraia',
    'Longneck': 'Grand-cou',
    'Loxodont': 'Loxodonta',
    'Shieldshell': 'Boucliarapace',
    'Wiggler': 'Anchet',
    'Wobbleback': 'Domollis',
    'Foxbat': 'Chauve-renard',
    'Nailtail': 'Queue clouée',
    'Tentabeard': 'Tentabarbe',
    'Trapmaw': 'Cage-gueule',
    'Stingback': 'Dardos',
    ...
    'Tubule': 'Tubule',
    'Twingrub': 'Gémelarve',
    'Buzzrunner': 'Buzzrunner',
    'Dropsalm': 'Dropsalm',
    'Fingerface': 'Digicéphale',
    'Fleshleaf': 'Phylocarnius',
    'Cobalt': 'Cobalt',
    'Eyespine': 'Irispinal',
    'Plateskin': 'Metalyderme',
    'Roundface': 'Rotonde',
    'Shroomhead': 'Champi',
    'Grylloba': 'Grylloba',
    'Fluke': 'Douve',
    'Kelpstrider': 'Algoculteur',
    'Leecher': 'Calovorus',
    'Reefwalker': 'Marcherécif',
    'Scoopback': 'Écope',
    'Stoneback': 'Lithoverso',
    'Twigwalker': 'Branchipode',
    'Hornwing': 'Cornoptère',
    'Bonecrest': 'Ostéocrète',
    'Hookneck': 'Nucroc',
    'Jellyfin': 'Méduse à palme',
    'Morningstar': 'Ombellium feuillue',
    'Mossgnath': 'Mossgnath',
    'Bearclaw': 'Griffe-ours',
    'Bladepack': 'Échinolame',
    'Featherfin': 'Poisson-plume',
    'Shroombobber': 'Mycoflotteur',
    'Siren': 'Sirène',
}
